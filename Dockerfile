...
# Install xterm.
RUN apt update && apt install -y wmctrl libatk1.0 libatk-bridge2.0 libgtk-3-0 libgbm-dev libxss1 libasound2 wget xterm libnss3 locales && wget https://download.breitbandmessung.de/bbm/Breitbandmessung-linux.deb && dpkg -i Breitbandmessung-linux.deb
RUN locale-gen de_DE.UTF-8

# Generate and install favicons.
# https://breitbandmessung.de/images/breitbandmessung-logo.png
